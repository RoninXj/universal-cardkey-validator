...
- **[完整文档](README-UNIVERSAL.md)** - 你正在阅读
...
**返回：**
- `Promise<Object|null>`: 添加了卡密的请求数据，验证失败返回 `null`
